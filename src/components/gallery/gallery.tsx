        ...
        <div className="flex overflow-hidden space-x-16 group">
            <div className="flex space-x-16 animate-loop-scroll group-hover:paused">
                <img loading="lazy"
                     ...
                     className="max-w-none" alt="Image 1"/>
                <img loading="lazy"
                     ...
                     className="max-w-none" alt="Image 2"/>
                <img loading="lazy"
                     ...
                     className="max-w-none" alt="Image 3"/>
                <img loading="lazy"
                     ...
                     className="max-w-none" alt="Image 4"/>
                <img loading="lazy"
                     ...
                     className="max-w-none" alt="Image 5"/>
                <img loading="lazy"
                     ...
                     className="max-w-none" alt="Image 6"/>
                <img loading="lazy"
                     ...
                     className="max-w-none" alt="Image 7"/>
                <img loading="lazy"
                     ...
                     className="max-w-none" alt="Image 8"/>
                <img loading="lazy"
                     ...
                     className="max-w-none" alt="Image 9"/>
                <img loading="lazy"
                     ...
                     className="max-w-none" alt="Image 10"/>
            </div>
